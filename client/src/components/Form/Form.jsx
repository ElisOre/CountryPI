...
function validate(activity) {
  ...
  if (!activity.name) err.name = "Name is required";
  if (!activity.dificulty) err.dificulty = "A difficulty is required";
  if (!activity.season) err.season = "A season is required";
  if (!activity.country.length) err.country = "Select at least one country";
